			...
			async get_obj_after(json, func){
				if (json.result && json.result.obj) {
					const obj = json.result.obj;
																														...
																														if(json.result.obj["statistics_date"]=="0000-00-00"){
				  json.result.obj["statistics_date"] = null;
				}
				if(parseInt(json.result.obj["statistics_date"]) > 9999){
					json.result.obj["statistics_date"] = this.$toTime(parseInt(json.result.obj["statistics_date"]),"yyyy-MM-dd")
				}
