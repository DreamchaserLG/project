		...
		<el-row class="row_ce">
				...
				<el-form-item label="公告内容" prop="announcement_content">
					...
					<ai_editor
						...
						:key="form.exhibition_announcement_id" 
			...
			async get_obj_after(json, func){
				...
				if(parseInt(json.result.obj["release_time"]) > 9999){
					json.result.obj["release_time"] = this.$toTime(parseInt(json.result.obj["release_time"]),"yyyy-MM-dd hh:mm:ss")
																								...
																								this.announcement_vuser_ideo_FileList = []
				if (json.result.obj["announcement_vuser_ideo"]) {
				    this.announcement_vuser_ideo_FileList = [
				        {
				            url: this.$fullUrl(json.result.obj['announcement_vuser_ideo']),
				            name: json.result.obj['announcement_vuser_ideo'],
				        },
				    ];
				}
