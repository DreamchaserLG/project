				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_refund_request v-if="$check_action('/refund_request/view','get')"></view_refund_request>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_refund_request from "../../components/diy/view_refund_request.vue";
	export default {
		data() {
			return {
			};
