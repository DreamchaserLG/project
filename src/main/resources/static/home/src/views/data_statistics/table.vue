				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<table_data_statistics v-if="$check_action('/data_statistics/table','get')"></table_data_statistics>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_data_statistics from "../../components/diy/table_data_statistics.vue";
	export default {
		data() {
			return {
			};
