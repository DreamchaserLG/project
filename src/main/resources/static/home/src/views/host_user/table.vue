				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 主办用户 -->
							<div><span>主办用户</span></div>
							<table_host_user v-if="$check_action('/host_user/table','get')"></table_host_user>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_host_user from "../../components/diy/table_host_user.vue";
	export default {
		data() {
			return {
			};
