...
`number_of_registrations` double(8,2) DEFAULT 1 comment '报名人数',
...
`number_of_attendees` double(8,2) DEFAULT 1 comment '到场人数',
`create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
`create_by` int(11) DEFAULT '1' NOT NULL comment '创建用户ID',
`update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
ALTER TABLE `refund_request` ADD COLUMN extra text comment '额外信息', ADD COLUMN source_table varchar(255) comment '来源表', ADD COLUMN source_id int(10) DEFAULT 0 comment '来源ID', ADD COLUMN source_user_id int(10) DEFAULT 0 comment '来源用户', ADD COLUMN is_deleted tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除', ADD COLUMN deleted_time datetime DEFAULT NULL COMMENT '逻辑删除时间', ADD COLUMN deleted_reason varchar(500) DEFAULT '' COMMENT '逻辑删除原因';
ALTER TABLE `registration_information` ADD COLUMN extra text comment '额外信息', ADD COLUMN source_table varchar(255) comment '来源表', ADD COLUMN source_id int(10) DEFAULT 0 comment '来源ID', ADD COLUMN source_user_id int(10) DEFAULT 0 comment '来源用户', ADD COLUMN is_deleted tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除', ADD COLUMN deleted_time datetime DEFAULT NULL COMMENT '逻辑删除时间', ADD COLUMN deleted_reason varchar(500) DEFAULT '' COMMENT '逻辑删除原因';
ALTER TABLE `travel_confirmation` ADD COLUMN extra text comment '额外信息', ADD COLUMN source_table varchar(255) comment '来源表', ADD COLUMN source_id int(10) DEFAULT 0 comment '来源ID', ADD COLUMN source_user_id int(10) DEFAULT 0 comment '来源用户', ADD COLUMN is_deleted tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除', ADD COLUMN deleted_time datetime DEFAULT NULL COMMENT '逻辑删除时间', ADD COLUMN deleted_reason varchar(500) DEFAULT '' COMMENT '逻辑删除原因';
ALTER TABLE `exhibition_information` ADD COLUMN is_deleted tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除', ADD COLUMN deleted_time datetime DEFAULT NULL COMMENT '逻辑删除时间', ADD COLUMN deleted_reason varchar(500) DEFAULT '' COMMENT '逻辑删除原因';
ALTER TABLE `booth_information` ADD COLUMN is_deleted tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除', ADD COLUMN deleted_time datetime DEFAULT NULL COMMENT '逻辑删除时间', ADD COLUMN deleted_reason varchar(500) DEFAULT '' COMMENT '逻辑删除原因';
ALTER TABLE `data_statistics` ADD COLUMN is_deleted tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除', ADD COLUMN deleted_time datetime DEFAULT NULL COMMENT '逻辑删除时间', ADD COLUMN deleted_reason varchar(500) DEFAULT '' COMMENT '逻辑删除原因';
