				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_data_statistics v-if="$check_action('/data_statistics/view','get')"></view_data_statistics>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_data_statistics from "../../components/diy/view_data_statistics.vue";
	export default {
		data() {
			return {
			};
