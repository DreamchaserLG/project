      ...
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
                ...
                <el-button @click="reset()" style="margin-right: 74px;" class="search_btn_reset">重置</el-button>
                                                                    <el-button v-if="$check_action('/exhibition_announcement/table','add') || $check_action('/exhibition_announcement/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
	    ...
	    <el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable" row-key="exhibition_announcement_id" :tree-props="{ children: 'children', hasChildren: 'hasChildren' }"
			:default-expand-all="isExpandAll" ref="tableRef">
	                <el-table-column fixed type="selection" tooltip-effect="dark" width="55">
                                                  ...
                                                  <el-table-column prop="announcement_title" @sort-change="$sortChange" label="公告标题"                                v-if="$check_field('get','announcement_title')" min-width="200">
                  {
                    <template slot-scope="scope">
                                          {{ scope.row['announcement_title'] }}
                                              ...
                                              <el-table-column prop="announcement_type" @sort-change="$sortChange" label="公告类型"                                v-if="$check_field('get','announcement_type')" min-width="200">
                  {
                    <template slot-scope="scope">
                      ...
                      {{ get_user_host_user(scope.row['host_user']) }}
                                      ...
                                      <template slot-scope="scope">
                                          {{ $toTime(scope.row["release_time"],"yyyy-MM-dd hh:mm:ss") }}
                                              ...
                                              <el-table-column prop="announcement_image" @sort-change="$sortChange" label="公告图片"                                v-if="$check_field('get','announcement_image')" min-width="200">
                                      <template slot-scope="scope">
                      <el-image style="width: 100px; height: 100px" :src="$fullUrl(scope.row['announcement_image'])"
                        ...
                        <div slot="error" class="image-slot">
                          <img src="../../../public/img/error.png" style="width: 90px; height: 90px" />
                                              ...
                                              <el-table-column prop="announcement_vuser_ideo" @sort-change="$sortChange" label="公告视频"                                v-if="$check_field('get','announcement_vuser_ideo')" min-width="200">
                                      <template slot-scope="scope">
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                        ...
                        <el-table-column fixed="right" label="操作" min-width="120" v-if="$check_action('/exhibition_announcement/table','set') || $check_action('/exhibition_announcement/view','set') || $check_action('/exhibition_announcement/view','get')
					 ">
      ...
      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
          ...
          <span>详情</span>
                                                            ...
                                                            <router-link v-if="$check_comment('/exhibition_announcement/table')" class="el-button el-button--small is-plain el-button--primary"
