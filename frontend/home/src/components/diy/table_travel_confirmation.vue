  ...
  <el-main class="bg table_wrap">
    <el-form label-position="right" :model="query" class="form p_4" label-width="120">
      ...
      <el-row class="rows row2">
	    ...
	    <el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable" row-key="travel_confirmation_id" :tree-props="{ children: 'children', hasChildren: 'hasChildren' }"
                                              ...
                                              <el-table-column prop="users_mobile_phone" @sort-change="$sortChange" label="用户手机"                                v-if="$check_field('get','users_mobile_phone')" min-width="200">
                  {
                    <template slot-scope="scope">
                                          {{ scope.row['users_mobile_phone'] }}
                                              ...
                                              <el-table-column prop="confirm_time" @sort-change="$sortChange" label="确认时间"                                v-if="$check_field('get','confirm_time')" min-width="200">
                                      <template slot-scope="scope">
                                          {{ $toTime(scope.row["confirm_time"],"yyyy-MM-dd hh:mm:ss") }}
                                                            </template>
                                </el-table-column>
                                              <el-table-column prop="number_of_attendees" @sort-change="$sortChange" label="到场人数"                                v-if="$check_field('get','number_of_attendees')" min-width="200">
                  {
                    <template slot-scope="scope">
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                        ...
                        <el-table-column fixed="right" label="操作" min-width="120" v-if="$check_action('/travel_confirmation/table','set') || $check_action('/travel_confirmation/view','set') || $check_action('/travel_confirmation/view','get')
					 ">
        

      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
                     v-if="$check_action('/travel_confirmation/table','set') || $check_action('/travel_confirmation/view','set') || $check_action('/travel_confirmation/view','get')"
  ...
  import mixin from "@/mixins/page.js";
    ...
    data() {
      return {
        ...
        url_del: "~/api/travel_confirmation/del?",
