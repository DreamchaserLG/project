                                              ...
                                              <el-table-column prop="users_mobile_phone" @sort-change="$sortChange" label="用户手机"                                v-if="$check_field('get','users_mobile_phone')" min-width="200">
                  {
                    <template slot-scope="scope">
                                          {{ scope.row['users_mobile_phone'] }}
                                              ...
                                              <el-table-column prop="number_of_registrations" @sort-change="$sortChange" label="报名人数"                                v-if="$check_field('get','number_of_registrations')" min-width="200">
                  {
                    <template slot-scope="scope">
                                          {{ scope.row['number_of_registrations'] }}
                                              ...
                                              <el-table-column prop="enterprise_qualifications" @sort-change="$sortChange" label="企业资质"                                v-if="$check_field('get','enterprise_qualifications')" min-width="200">
                                      <template slot-scope="scope">
                      <a :href="$fullUrl(scope.row['enterprise_qualifications'])" target="_blank" style="color: rgb(64, 158, 255);">点击下载</a>
                    </template>
                                </el-table-column>
                                              <el-table-column prop="registration_notes" @sort-change="$sortChange" label="报名备注"                                v-if="$check_field('get','registration_notes')" min-width="200">
                  {
                    <template slot-scope="scope">
                                          {{ scope.row['registration_notes'] }}
                                              ...
                                              <el-table-column prop="site_plan" @sort-change="$sortChange" label="场地平面图"                                v-if="$check_field('get','site_plan')" min-width="200">
                                      <template slot-scope="scope">
                      <el-image style="width: 100px; height: 100px" :src="$fullUrl(scope.row['site_plan'])"
                        ...
                        <div slot="error" class="image-slot">
                          <img src="../../../public/img/error.png" style="width: 90px; height: 90px" />
                                              ...
                                              <el-table-column prop="exhibitor_documents" @sort-change="$sortChange" label="参展文件"                                v-if="$check_field('get','exhibitor_documents')" min-width="200">
                                      <template slot-scope="scope">
                      <a :href="$fullUrl(scope.row['exhibitor_documents'])" target="_blank" style="color: rgb(64, 158, 255);">点击下载</a>
                    </template>
                                </el-table-column>
