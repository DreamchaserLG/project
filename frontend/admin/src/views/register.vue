<template>
	<article class="sign_in register_wrap">
		<div class="warp">
			<el-row>
				<el-col style="height: calc(100vh - 1rem);">
					<el-form :model="form" ref="form" label-width="80px" class="form" :style="loginFormPos">
						...
						<el-form-item label="确认密码" prop="confirm_password">
							<el-input type="password" v-model="confirm_password" placeholder="请再次输入密码"
								autocomplete="off">
							</el-input>
						</el-form-item>
						...
						<el-form-item label="身份" prop="user_group">
							<el-select v-model="form.user_group" placeholder="身份">
								...
								<!-- 主办用户 -->
						<form_host_user v-if="form.user_group === '主办用户'" :form="form_sub" ></form_host_user>
...
<script>
	import mixin from "@/mixins/page.js";
			/* 主办用户 */
	import form_host_user from "@/components/diy/form_host_user";
